...
export default function UpcomingFilings() {
  ...
  if (loading) {
    return (
      <div className="w-full bg-gradient-to-r from-blue-50 to-indigo-50 border-y border-blue-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 py-4">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <span className="text-sm font-medium text-gray-700">Estimated Upcoming Filings</span>
          </div>
            ...
            <div className="flex gap-3 pb-1">
              {filings.map((filing) => (
                <Link
                  ...
                  className="group flex items-center gap-2 px-3 py-1.5 bg-white rounded-md border border-blue-200 hover:border-blue-400 hover:shadow-sm transition-all flex-shrink-0"
                >
                  {/* Ticker */}
